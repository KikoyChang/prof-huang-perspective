...
这个 skill 适用于网络社会、空间生产、社会性艺术、田野行动、AI、协议政治、Web3/P2P、研究设计和学术写作方法等主题。

本 skill 不代表Prof. Huang本人观点，只是一个基于公开材料与整理性研究笔记形成的辅助分析框架。

## 功能

- 拯救笨蛋学生，尝试以prof.Huang的视角分析技术、艺术、空间、网络、政治经济、行动、文献地图和研究设计等视角辅助分析问题。
- 帮助笨蛋学生可帮助把宽泛主题转化为可讨论的问题意识、文献地图、案例逻辑、方法论和论文结构。（ **不能直接用于写作！！！！**）
